...
export interface Settings {
  ...
  SETTING_SHOW_NOON_MIDNIGHT_MARKERS: number;
  SETTING_NOON_MARKER_COLOR: string;
  SETTING_MIDNIGHT_MARKER_COLOR: string;
  SETTING_NIGHT_NOON_MARKER_COLOR: string;
  SETTING_NIGHT_MIDNIGHT_MARKER_COLOR: string;
  SETTING_NOON_MIDNIGHT_LINE_WIDTH: number;
  SETTING_SHOW_TIDE_PLOT: number;
  SETTING_TIDE_PLOT_INSIDE: number;
  SETTING_TIDE_PLOT_COLOR: string;
  SETTING_NIGHT_TIDE_PLOT_COLOR: string;
  SETTING_TIDE_PLOT_BORDER: number;
  SETTING_TIDE_PLOT_BORDER_COLOR: string;
  SETTING_NIGHT_TIDE_PLOT_BORDER_COLOR: string;
  SETTING_TIDE_AMPLITUDE: number;
  SETTING_TIDE_BAR_WIDTH: number;
  SETTING_TIDE_BAR_GAP: number;
  SETTING_TIDE_BORDER_WIDTH: number;
  SETTING_NOAA_STATION_ID: string;
}
