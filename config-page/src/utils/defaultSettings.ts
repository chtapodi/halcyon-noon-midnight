...
export const getDefaultSettings = (capabilities: Capabilities): Settings => ({
  ...
  SETTING_SHOW_NOON_MIDNIGHT_MARKERS: 1,
  SETTING_NOON_MIDNIGHT_LINE_WIDTH: 5,
  SETTING_NOON_MARKER_COLOR: 'FF5500',
  SETTING_MIDNIGHT_MARKER_COLOR: '555555',
  SETTING_NIGHT_NOON_MARKER_COLOR: 'FFAA00',
  SETTING_NIGHT_MIDNIGHT_MARKER_COLOR: '5555FF',
  SETTING_SHOW_TIDE_PLOT: 0,
  SETTING_TIDE_PLOT_INSIDE: 1,
  SETTING_TIDE_PLOT_COLOR: '00FF00',
  SETTING_NIGHT_TIDE_PLOT_COLOR: '00FF00',
  SETTING_TIDE_PLOT_BORDER: 0,
  SETTING_TIDE_PLOT_BORDER_COLOR: '000000',
  SETTING_NIGHT_TIDE_PLOT_BORDER_COLOR: capabilities.BW ? 'FFFFFF' : 'FFFFFF',
  SETTING_TIDE_AMPLITUDE: 16,
  SETTING_TIDE_BAR_WIDTH: 0,
  SETTING_TIDE_BAR_GAP: 0,
  SETTING_TIDE_BORDER_WIDTH: 3,
  SETTING_NOAA_STATION_ID: '',
});
