...
export const SVGPreview: React.FC<SVGPreviewProps> = ({ themeType, title }) => {
  ...
  useEffect(() => {
    ...
    // Load all colors for this theme type
    const loadColors = () => {
      const colorSettings = [
        'SETTING_TIME_COLOR',
      ...
      colorSettings.forEach(setting => {
        const color = themeManager.getColor(setting, themeType);
        if (color) {
    ...
    <div className="svg-preview-container">
      ...
      <div className="svg-wrapper">
        ...
        >
          ...
          {/* Ring Stroke */}
          <g id="SETTING_RING_STROKE_COLOR" fill={colors.SETTING_RING_STROKE_COLOR || '#000000'}>
