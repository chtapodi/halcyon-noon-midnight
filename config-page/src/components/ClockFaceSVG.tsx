...
interface ClockFaceSVGProps {
  colors: Record<string, string>;
}

export const ClockFaceSVG: React.FC<ClockFaceSVGProps> = ({ colors }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 168" fill="none">
      <path fill={getColor('SETTING_RING_NIGHT_COLOR', '#05A')} d="M0 86h144v82H0z" />
      <path fill={getColor('SETTING_RING_DAY_COLOR', '#05AAFF')} d="M0 0h144v82H0z" />
      <path
        fill={getColor('SETTING_SUN_FILL_COLOR', '#FFA')}
        d="M52 8.5a8.5 8.5 0 1 1-17 0 8.5 8.5 0 0 1 17 0Z"
      />
      <path
        fill={getColor('SETTING_SUN_STROKE_COLOR', '#000')}
        fillRule="evenodd"
        d="M43.5 14a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11Zm0 3a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Z"
        clipRule="evenodd"
      />
      <path fill={getColor('SETTING_RING_SUNRISE_COLOR', '#FAA')} d="M19 72v25H0V72h19Z" />
      <path fill={getColor('SETTING_RING_SUNSET_COLOR', '#FFAA01')} d="M144 72v25h-19V72h19Z" />
      <path fill={getColor('SETTING_BG_COLOR', '#fff')} d="M16 16h112v136H16z" />
      <path
        fill={getColor('SETTING_PIP_COLOR_SECONDARY', '#AAA')}
      ...
      />
      <path
        fill={getColor('SETTING_PIP_COLOR_PRIMARY', '#000')}
        d="M17 83h6v3h-6v-3ZM70 23v-5h3v5h-3ZM70 151v-6h3v6h-3ZM121 83h6v3h-6v-3Z"
      />
      <g fill={getColor('SETTING_RING_STROKE_COLOR', '#000')} fillRule="evenodd" clipRule="evenodd">
